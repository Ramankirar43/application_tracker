...
const io = socketIo(server, {
  cors: {
    origin: process.env.FRONTEND_URL || "https://application-trackerraman-ramankirar43s-projects.vercel.app",
    methods: ["GET", "POST"]
  }
});
...
app.get('/api/health', (req, res) => {
  res.json({ 
    ...
    deployment: 'Render',
    frontend: process.env.FRONTEND_URL || 'https://application-trackerraman-ramankirar43s-projects.vercel.app'
  });
});
...
//   "http://localhost:3000",
//   "https://application-trackerraman-ramankirar43s-projects.vercel.app"
// ];
